...
return [
    ...
    "CURRENT_PASSWORD_NOT_MATCH"=>"Your current password does not match with password you provided.",
    "PASSWORD_UPDATE_SUCCESS"=>"Password has been updated successfully.",
    "SEND_PUSH_NOTIFICATION_SUCCESS" => "Push notification has been sent successfully.",
    "SEND_EMAIL_SUCCESS" => "Email has been sent successfully.",
    "ACCOUNT_DELETE_SUCCESS" => "You account has been deleted successfully.",
    "LOGIN_DEVICE_STORE_SUCCESS" => "Login device details have been stored successfully.",
