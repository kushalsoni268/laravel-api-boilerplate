                            ...
                            <tr style="vertical-align: top">
                              <td align="left" valign="middle"
                                ...
                                <a href=" " title="Facebook" target="_blank">
                                  <img src="{{ asset('assets/admin/email-template/image-2.png') }}" alt="Facebook" title="Facebook" width="32"
                            ...
                            <tr style="vertical-align: top">
                              <td align="left" valign="middle"
                                ...
                                <a href=" " title="Twitter" target="_blank">
                                  <img src="{{ asset('assets/admin/email-template/image-4.png') }}" alt="Twitter" title="Twitter" width="32"
                                    style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                </a>
                              </td>
                            </tr>
                            ...
                            <tr style="vertical-align: top">
                              <td align="left" valign="middle"
                                ...
                                <a href=" " title="Instagram" target="_blank">
                                  <img src="{{ asset('assets/admin/email-template/image-3.png') }}" alt="Instagram" title="Instagram" width="32"
                                    style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                </a>
                              </td>
                            </tr>
                            ...
                            <tr style="vertical-align: top">
                              <td align="left" valign="middle"
                                ...
                                <a href=" " title="LinkedIn" target="_blank">
                                  <img src="{{ asset('assets/admin/email-template/image-6.png') }}" alt="LinkedIn" title="LinkedIn" width="32"
                                    style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                </a>
                              </td>
                            </tr>
