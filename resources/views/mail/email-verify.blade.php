			...
			<tbody>
				...
				<td
					...
					<p style="font-size: 14px; line-height: 140%; text-align: center;"><span
						style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;">Email Verification</span></p>
					</div>
			...
			<div
				...
				<tbody>
					...
					<td
						...
						<p style="font-size: 14px; line-height: 140%;"><span
							style="font-size: 18px; line-height: 25.2px; color: #666666;">Please verify email to login.</span></p>						
					</td>
					</tr>
				</tbody>
				</table>
				...
				<tbody>
					<tr>
					<td
						style="overflow-wrap:break-word;word-break:break-word;padding:0px 40px 40px;font-family:'Lato',sans-serif;"
						align="left">						
						<div align="left">						
						<a href="{{ $data['url'] }}" target="_blank" class="v-button"
